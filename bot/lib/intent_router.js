...
const INTENTS = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /\b(build|make|put up|build me|set up|construct|design|create)\b.*\b(observatory|telescope|stargazing|wizard\s*(?:tower|spire|castle)|mage\s*(?:tower|spire)|magic\s*(?:tower|spire)|market|marketplace|bazaar|village\s*square|town\s*square|sky\s*bridge|sky\s*walkway|sky\s*overpass|beacon\s*plaza|gallery\s*plaza|light\s*plaza)\b/i,
